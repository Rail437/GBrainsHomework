...
public class MainClass {
    public static void main(String[] args) {
        ...
        System.out.println(searchFiles(new File("D:/GBrainsHomework"), checkWord));
    }
    ...
    private static boolean searchFiles(File folder, String word) {
        if(folder.isDirectory()) {
            System.out.println("searching at: " + folder.getAbsolutePath());
        ...
        if(folderEntries != null) {
            for (File entry : folderEntries) {
                ...
                if (entry.isDirectory()) {
                    searchFiles(entry, word);
                    continue;
                } else {
                    System.out.println("Hohoh");
                    if (checkWord(word, entry.getAbsolutePath()) == true) {
                        return true;
                    }
                }
